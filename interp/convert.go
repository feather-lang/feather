...
// ListLen returns the length of a list object.
...
// ListAt returns the element at index i in a list object.
...
// ListAppend appends an element to a list object.
...
// ListSet sets the element at index i in a list object.
// Does nothing if the object is not a list or index is out of bounds.
// Invalidates the string representation.
func ListSet(o *Obj, i int, elem *Obj) {
	if o == nil || elem == nil {
		return
	}
	if c, ok := o.intrep.(IntoList); ok {
...
// DictGet returns the value for a key in a dict object.
...
// DictSet sets a key-value pair in a dict object.
...
// DictKeys returns the keys of a dict object in insertion order.
// Returns nil if the object is not a dict.
func DictKeys(o *Obj) []string {
	if o == nil {
		return nil
	}
	if c, ok := o.intrep.(IntoDict); ok {
...
// DictLen returns the number of keys in a dict object.
// Returns 0 if the object is nil or not a dict.
func DictLen(o *Obj) int {
	if o == nil {
		return 0
	}
	if c, ok := o.intrep.(IntoDict); ok {
